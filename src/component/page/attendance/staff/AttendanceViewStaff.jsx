...
const groupAttendanceByEmployee = (attendanceList, selectedDate) => {
    ...
    attendanceList.forEach(attendance => {
        ...
        switch (status) {
            case 'Present':
                groupedData[staffId].totalPresent += 1;
                break;
            case 'Absent':
                groupedData[staffId].totalAbsent += 1;
                break;
            case 'Late':
                groupedData[staffId].totalLate += 1;
                break;
            case 'Half Day':
                groupedData[staffId].totalHalfDay += 1;
                break;
            case 'Leave':
                groupedData[staffId].totalLeave += 1;
                break;
            case 'Holiday':
                groupedData[staffId].totalHoliday += 1;
                break;
            default:
                break;
        }
                ...
                <Table style={{tableLayout: 'fixed'}}>
                    <TableHead>
                        <TableRow style={headerStyle}>
                            <TableCell style={{...cellStyleNameHeader, ...headerStyle}}>Employee Name</TableCell>
                    ...
                    <TableBody>
                        {Object.entries(groupedData).map(([staffId, employeeData], index) => (
